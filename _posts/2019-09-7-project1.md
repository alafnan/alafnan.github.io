...
<table>
  ...
  <tfoot border: 1px solid black;>
    <tr>
      <td style="color:#000000; background-color: #F0EAD6;">Recommended hours</td>
      <td style="color:#000000; background-color: #F0EAD6;"> </td>
      <td style="color:#000000; background-color: #F0EAD6;"> </td>
      <td style="color:#000000; background-color: #F0EAD6;">8:00 AM, 12:00 PM, 4:00 PM</td>
    </tr>
  </tfoot>
  <tbody border: 1px solid black;>
    <tr>
      <td style="color:#000000; background-color: #F0EAD6;">Recommended Station</td>
      <td style="color:#000000; background-color: #F0EAD6;">34 ST-PENN STA, GRD Central-42 ST, 34 ST-Herald SQ, 14 ST-Union SQ, 32 ST 15</td>
      <td style="color:#000000; background-color: #F0EAD6;"> </td>
      <td style="color:#000000; background-color: #F0EAD6;"> </td>
    </tr>
    <tr>
      <td style="color:#000000; background-color: #F0EAD6;">Recommended days</td>
      <td style="color:#000000; background-color: #F0EAD6;"> </td>
      <td style="color:#000000; background-color: #F0EAD6;">Tuesday, Monday, Wednesday</td>
      <td style="color:#000000; background-color: #F0EAD6;"> </td>
    </tr>
  </tbody>
</table>
